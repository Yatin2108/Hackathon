...
curl \
  ...
  -d '{"state": "success", "target_url": "https://app-automate.browserstack.com/dashboard/v2", "description": "Tests passed", "context": "ci/service"}' \
  "https://api.github.com/repos/browserstack/app-percy-demo/statuses/$(git rev-parse --verify HEAD)"
